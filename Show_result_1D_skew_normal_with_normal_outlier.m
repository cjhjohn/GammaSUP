%**************************************************************************
%--- Plot the results of the case "Skew normal distributions with outlier"
...
for ii = 1 : n
    ...
    if( Object_cluster(ii)> 3 ), ph = plot( cx, ofv(:,ii) , 'k' ) ; set(ph, 'LineWidth',1); end
    axis( [ -5 , 10 , 0 , 0.85 ] );
    hold on
...
filename = strcat( 'Fig_skew_outlier_final.eps' ) ;
saveas(gcf,filename,'psc2') ; 
hold off
